...
const (
	...
	missingRoleHeaderErr = "missing user role header"
...
func ReadUserRole(r *http.Request) (*string, error) {
	id := r.Header.Get("role")
	if id == "" {
		return nil, errors.New(missingRoleHeaderErr)
	}
